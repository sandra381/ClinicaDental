...
<html>
    ...
    <div class="example-card" >
        ...
        <div class = "example-form">
            <form name="datos" method="post" action="pagos_insert.php" accept-charset="UTF-8">
                ...
                <div class="field" tabindex="3">
                    <label for="citapagos">ID de la Cita</label>
                    <input name="citapagos" type="number" required>
                </div>
                <div class="field" tabindex="4">
                    ...
                    <select name="tipopago">
                        <option value="" selected></option>
                            <?php
                                $sql ="select idtipo,nombretipo from tipo_pago order by nombretipo";
                                $pagostipo = mysqli_query($conexion,$sql);
                                while($pagostipos  = mysqli_fetch_array($pagostipo )){
                                    echo '<option value = "' . $pagostipos["idtipo"] . '">' . $pagostipos["nombretipo"] . '</option>';
                                } 
                            ?>
                    </select>
                </div>
