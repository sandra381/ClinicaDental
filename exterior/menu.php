...
<html>
    ...
    <header>
            <ul class="menu-bar">
                ...
                <li class="<?php echo $paginas == 'sobrenosotros' ? 'active':'';?>"><a href="?p=sobrenosotros">Contáctanos</a></li>
                <li class="<?php echo $paginas == 'servicios' ? 'active':'';?>"><a href="?p=servicios">Servicios</a></li>
                <li class="<?php echo $paginas == 'login' ? 'active':'';?>"><a href="?p=login">Login</a></li>
            </ul>      
    </header>
    </body>
</html>
