...
<html>
    ...
    <div class="example-card" >
        ...
        <div class = "example-form">
            <form name="datos" method="post" action="usuario_insert.php" accept-charset="UTF-8">
                <div class="field" tabindex="1">
                    <label for="dpi">DPI</label>
                    <input name="dpi" type="text" required>
                </div>
                ...
                <div class="field" tabindex="4">
                    ...
                    <input name="fecha_nac" type="text" required>
                </div>
                ...
                <div class="field" tabindex="7">
                    ...
                    <?php
                        $comb = "1234567890abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ.@$&#*-_=+";
                        $shfl = str_shuffle($comb);
                        $pwd = substr($shfl,0,10);
                        echo " <input type='text' name='clave'  minlength='10' value='$pwd' readonly> ";
                    ?>
                </div>
                <div class="field" tabindex="8">
                    <label for="dir">Direccion</label>
                    <textarea name="dir" placeholder="Ej. 3ra calle zona 12" required></textarea>
                </div>
                <div class="field" tabindex="9">
                    <label for="alergias">Alergias</label>
                    <input name="alergias" type="text" required>
                </div>
